...
def _default_access_level(menu: MenuDef, role: Role) -> str:
    ...
    defaults: dict[str, dict[Role, str]] = {
        ...
        "master_uang_pelabuhan": {Role.ADMIN: "full", Role.FINANCE: "read", Role.MARKETING: "full", Role.GUDANG: "read"},
        "master_pjr": {Role.ADMIN: "full", Role.FINANCE: "read", Role.MARKETING: "full", Role.GUDANG: "read"},
        "master_forklift_bongkaran": {Role.ADMIN: "full", Role.FINANCE: "read", Role.MARKETING: "full", Role.GUDANG: "read"},
        "master_parkir_liar": {Role.ADMIN: "full", Role.FINANCE: "read", Role.MARKETING: "full", Role.GUDANG: "read"},
        "master_parkir_kawasan": {Role.ADMIN: "full", Role.FINANCE: "read", Role.MARKETING: "full", Role.GUDANG: "read"},
